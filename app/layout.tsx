  ...
  return (
    <html lang="en">
      <body className="antialiased">
        <a
          href="#main-content"
          className="absolute left-4 top-4 z-[100] -translate-y-[150%] rounded-md bg-emerald-400 px-4 py-2 font-bold text-slate-950 transition-transform focus:translate-y-0"
        >
