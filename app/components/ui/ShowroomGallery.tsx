          ...
          <div key={index} className="flex-none w-[85vw] md:w-[600px] snap-center first:pl-0">
            ...
            >
              ...
              <div className="p-6 md:p-8 relative z-10 bg-white dark:bg-slate-900 flex flex-col flex-grow transition-colors">
                ...
                <a href="#" aria-label={`View case study for ${project.title}`} className="inline-flex items-center gap-2 text-sm font-medium text-slate-900 dark:text-white hover:text-brand-palay transition-colors mt-auto group/link">
